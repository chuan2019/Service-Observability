...
class PaymentService:
    ...
    async def _validate_payment_data(self, payment_data: Dict[str, Any]) -> None:
        ...
        with tracer.start_as_current_span(
            "payment_service.validate_payment_data"
        ) as span:
            span.set_attribute("service", "payment")
            ...
            missing_fields = [
                field for field in required_fields if field not in payment_data
            ]
    ...
    async def _record_payment(
        self, payment_data: Dict[str, Any], gateway_response: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        with tracer.start_as_current_span("payment_service.record_payment") as span:
            ...
            if payment["status"] == "failed":
                ...
                raise ValueError(
                    f"Payment failed: {gateway_response.get('error_message', 'Unknown error')}"
                )
    ...
    async def refund_payment(
        self, payment_id: int, amount: float = None
    ) -> Dict[str, Any]:
